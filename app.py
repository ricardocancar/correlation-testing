...
def analizar_macro_mensual(start_hist, start_recent, end_date):
    ...
    macro = web.DataReader(list(tickers_fred.keys()), 'fred', start_hist, end_date)
    macro.rename(columns=tickers_fred, inplace=True)
...
if __name__ == "__main__":
    ...
    with st.spinner('Descargando y procesando datos...'):
        # Ejecutar cálculos
        tabla_macro, precio_oro = analizar_macro_mensual(fecha_inicio_hist, fecha_inicio_reciente, fecha_fin)
